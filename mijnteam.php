  ...
  <div id="mySidenav" class="sidenav">
    ...
    <div class="sidebarmid">
      <ul>
        ...
        <li><a href="chatscherm.php">Sponsor nieuws</a></li>
        <li><a href="wedstrijden.php">Wedstrijden</a></li>
        <li class="active"><a href="mijnteam.php">Mijn team</a></li>
        ...
        <li><a href="connections.php">Mijn connections</a></li>
      </ul>
      </div>
...
<div id="main">
  <header class="header">
      ...
      <div class="top">Mijn Team</div>
      <ul>
        <li>
  </header>
  <main class="main">
    <div class="mijnteamcontent">
                     ...
                     $result = $conn ->query("SELECT * FROM teams");
                      if($result->num_rows != 0){
                        while($rows = $result->fetch_assoc()){
                          $id = $rows['team_id'];
                          $name = $rows['team_naam'];
                        echo '<div class="bsblock"><h3>' . $name . '</h3></div>';
                      }
               }?>
