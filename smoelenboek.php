  ...
  <div id="mySidenav" class="sidenav">
    ...
    <div class="sidebarmid">
      <ul>
        ...
        <li class="active"><a href="smoelenboek.php">smoelenboek</a></li>
...
<div id="main">
  ...
  <main class="main">
    ...
    <div id="input_container">
      ...
      <div style="text-align: center; color:grey;">Alle zoekresultaten</div>
      ...
      <div id="sponsor">
              ...
              include_once("includes/db.php");
                     $result = $conn ->query("SELECT sponsers.sponsernaam, leden.voornaam, leden.achternaam, leden.Lid_id FROM leden INNER JOIN sponsers ON leden.Sponser_id = sponsers.sponser_id");
                      if($result->num_rows != 0){
                        while($rows = $result->fetch_assoc()){
                          $id = $rows['Lid_id'];
                          $voornaam = $rows['voornaam'];
                          $achternaam = $rows['achternaam'];
                          $sponser = $rows['sponsernaam'];
                        echo '<div class="bsblocksmoel"><img src="images/head/' . $id .'.png"/><h3>' . $voornaam . ' ' . $achternaam . '</h3><p>' . $sponser . '</p></div>';
                      }
               }?>
